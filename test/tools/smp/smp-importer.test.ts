...
import { SmpImportService } from '../../../src/contributions/tools/smp/import/index.js';
import { detectSmpImportKind, getDefaultImportedXsmpPath, parseSmpXml } from '../../../src/contributions/tools/smp/import/index.js';
...
describe('SMP importer', () => {
    ...
    test('imports a catalogue and regenerates the same SMP XML', async () => {
        ...
        expect(isCatalogue(document.parseResult.value)).toBe(true);
