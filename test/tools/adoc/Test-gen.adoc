...
namespace ns {
                ...
                class SingleAttribute { <<AttributeType>> }
class MultipleAttribute { <<AttributeType>> }
class ArrayOf3Bool { <<Array>> }
class MatrixOf3_3Bool { <<Array>> }
class ArrayOf3Char8 { <<Array>> }
class ArrayOf3Int8 { <<Array>> }
                class - { <<...>> }
...
.^h|Extends |<<Smp-Exception,Smp::Exception>>
|===
...
....
classDiagram
    class AnAbstractException { <<Exception>> }
...
.^h|Primitive Type |<<Smp-Float64,Smp::Float64>>
.^h|Minimum |0 (exclusive)
.^h|Maximum |100 (exclusive)
|===
...
.2+.^h|Extends |<<Smp-IComponent,Smp::IComponent>> |<<Smp-ICollection,Smp::ICollection>>
|===
...
.AnInterface's public constants
[%autowidth.stretch]
|===
|Name |Type |Value
...
.AnInterface's public properties
[%autowidth.stretch]
|===
|Name |Type
...
|inout |inout |<<Smp-Duration,Smp::Duration>> |nullptr |a desc1
|return |return |<<Smp-Bool,Smp::Bool>> | |
|===
[#ns-AnAbstractModel]
...
[%autowidth.stretch]
|===
|Kind |Name |Type |View Kind |Initial Value
...
....
classDiagram
    class AnAbstractModel { <<Model>> }
    class AnInterface { <<Interface>> }
    class IComposite { <<Reference>> }
    class IComposite { <<Reference>> }
    class IComposite { <<Reference>> }
    class IComposite { <<Reference>> }
    class IComposite { <<Reference>> }
    ...
    AModel "1" o-- IComposite : reference
    AModel "?" o-- IComposite : optional_reference
    AModel "*" o-- IComposite : list_reference
    AModel "+" o-- IComposite : non_empty_list_reference
    AModel "4" o-- IComposite : list_reference_4
    AModel "4 .. *" o-- IComposite : list_reference_4_or_more
    AModel "4 .. 10" o-- IComposite : list_reference_betwwen_4_and_10
    AModel "1" *-- IModel : container
    AModel "?" *-- IModel : optional_container
    AModel "*" *-- IModel : list_container
    AModel "+" *-- IModel : non_empty_list_container
    AModel "4" *-- IModel : list_container_4
    AModel "4 .. *" *-- IModel : list_container_4_or_more
...
[%autowidth.stretch]
|===
|Kind |Name |Type |Unit |Initial Value
