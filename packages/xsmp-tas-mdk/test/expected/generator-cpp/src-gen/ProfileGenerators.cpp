...
extern "C"
{
    ...
    bool Initialise_ProfileGenerators(
        ...
        simulator->RegisterFactory(new ::TasMdk::Factory(
                            ...
                            "::demo::support::ChildModel", // Type name
                            [](::Smp::String8 name,
                                ::Smp::String8 description,
                                ::Smp::IObject* parent,
                                ::Smp::Publication::ITypeRegistry* type_registry) {
                                    return new ::demo::support::ChildModel(name, description, parent, type_registry);
        ...
        simulator->RegisterFactory(new ::TasMdk::Factory(
                            ...
                            "::demo::support::RootModel", // Type name
                            [](::Smp::String8 name,
                                ::Smp::String8 description,
                                ::Smp::IObject* parent,
                                ::Smp::Publication::ITypeRegistry* type_registry) {
                                    return new ::demo::support::RootModel(name, description, parent, type_registry);
                                }, // Instantiation callback
                            typeRegistry // Type Registry
                            ));
