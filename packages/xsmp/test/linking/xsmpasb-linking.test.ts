...
import { Assembly, AssemblyInstance, Project, isAssembly, isAssemblyInstance, isProject } from '@xsmp/core/ast-partial';
...
function getAssemblyInstance(document: LangiumDocument<Assembly>): AssemblyInstance {
    ...
    expect(isAssemblyInstance(instance)).toBe(true);
    return instance as AssemblyInstance;
}
