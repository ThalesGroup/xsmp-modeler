...
namespace demo
{
    namespace support
    {
                 ...
                 constexpr ::Smp::Uuid Uuid_MonitorService { 0xeeeeeeeeU, 0xeeeeU, 0x4eeeU, 0x8eeeU, 0xeeeeeeeeeeeeU };

                 class MonitorServiceGen: public ::TasMdk::Service
                 {
                 ...
                 public:
                     ...
                     static ::TasMdk::Request::Handler<MonitorServiceGen>::CollectionType requestHandlers;
        ...
        template <typename _Type>
        void MonitorServiceGen::PopulateRequestHandlers(
            ...
            [[maybe_unused]] typename ::TasMdk::Request::Handler<_Type>::CollectionType& handlers)
        {
                     ...
                     if (handlers.find("get_Running") == handlers.end()) {
                         handlers["get_Running"] = [](_Type & component, ::Smp::IRequest* request) {
                             /// Invoke get_Running
                             request->SetReturnValue({::Smp::PrimitiveTypeKind::PTK_Bool, component.get_Running()});
                         };
                     }


                     if (handlers.find("set_Running") == handlers.end()) {
                         handlers["set_Running"] = [](_Type & component, ::Smp::IRequest* request) {
                             /// Invoke set_Running
                             ::Smp::Bool Running;
                             ::TasMdk::Request::initParameter(Running, request, "Running", ::Smp::PrimitiveTypeKind::PTK_Bool);
                             component.set_Running(Running);
                         };
                     }
